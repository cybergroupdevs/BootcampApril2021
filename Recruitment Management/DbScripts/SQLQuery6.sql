...
/****** Object:  Database [Rms]    Script Date: 26-04-2021 11:14:00 ******/
CREATE DATABASE [Rms]
 CONTAINMENT = NONE
 ON  PRIMARY 
( NAME = N'Rms', FILENAME = N'C:\Program Files\Microsoft SQL Server\MSSQL14.MSSQLSERVER\MSSQL\DATA\Rms.mdf' , SIZE = 8192KB , MAXSIZE = UNLIMITED, FILEGROWTH = 65536KB )
 LOG ON 
( NAME = N'Rms_log', FILENAME = N'C:\Program Files\Microsoft SQL Server\MSSQL14.MSSQLSERVER\MSSQL\DATA\Rms_log.ldf' , SIZE = 8192KB , MAXSIZE = 2048GB , FILEGROWTH = 65536KB )
GO

ALTER DATABASE [Rms] SET COMPATIBILITY_LEVEL = 140
GO
